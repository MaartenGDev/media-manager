...
var _whatwgFetch = __webpack_require__(9);
...
var buildActionBar = function buildActionBar(settings) {
...
var postFileToEndpoint = function postFileToEndpoint(endpoint, file) {
  return new Promise(function (resolve, reject) {
    var data = new FormData();
    data.append('file', file);

    (0, _whatwgFetch2.default)(endpoint, {
      method: 'POST',
      body: data
...
var registerEventListenersForActionBar = function registerEventListenersForActionBar(settings) {
  var uploadSelector = (0, _css.mergeClasses)((0, _css.createClassSelectors)((0, _array.toArray)(settings.classes.uploadButton)));

  document.querySelector(uploadSelector).addEventListener('change', function (evt) {
    var file = evt.target.files[0];

    postFileToEndpoint(settings.uploadEndpoint, file).then(function (uploadedFile) {
      return settings.events.onUploaded(uploadedFile);
    });
  });
};

var registerEventListenersForMediaActions = function registerEventListenersForMediaActions(settings) {
  var selectedPaths = [];
  ...
  var confirmSelector = (0, _css.mergeClasses)((0, _css.createClassSelectors)((0, _array.toArray)(settings.classes.confirmButton)));
...
exports.createClassSelectors = exports.mergeClasses = exports.addClassesToNode = undefined;
...
var createClassSelectors = exports.createClassSelectors = function createClassSelectors(classes) {
  return classes.map(function (c) {
    return '.' + c;
  });
};

exports.default = { addClassesToNode: addClassesToNode, mergeClasses: mergeClasses, createClassSelectors: createClassSelectors };
